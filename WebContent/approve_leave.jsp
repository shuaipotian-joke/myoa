                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <c:if test="${Object=='baoxiaoProcess'}">
                            ...
                            <div class="form-group">
                            	<c:forEach items="${buttonName}" var="b">
                               		<input type="submit"  class="btn btn-primary" value="${b}" name="message"/>
                            	</c:forEach>
                            </div>
                        </div>
                </div>
